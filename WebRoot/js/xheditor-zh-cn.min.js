function jwys(obj){
	$(obj).xheditor({tools:'Cut,Copy,Paste,Pastetext,Separator,Bold,Italic,Underline,Strikethrough,Separator,Fontface,FontSize,FontColor,BackColor,Removeformat,Separator,Align,List,Indent,Outdent,Separator,Link,Unlink,About'});
}
